...
# in VCFv4.1 :
# If the field has one value per alternate allele then this value 
# should be 'A'; if the field has one value for each possible genotype 
# (more relevant to the FORMAT tags) then this value should be 'G'.  
# If the number of possible values varies, is unknown, or is unbounded, 
# then this value should be '.'. 
    if tagNumber == "." or tagNumber == "A" or tagNumber == "G": tagNumber = "variable"
    else:
